    ...
    pub fn build_settings_tab(&mut self, ui: &mut egui::Ui) {
        egui::ScrollArea::vertical().show(ui, |ui| {
            ...
            section_header(
                ui,
                icons::GEAR_FINE,
                &t!("ui.settings.app.heading"),
                &t!("ui.settings.app.description"),
            );
            ui.group(|ui| {
                ui.set_width(ui.available_width());
                ...
                if ui
                    .checkbox(
                        ...
                        t!("ui.settings.app.send_replay_data"),
                    )
                    .changed()
                {
                ...
                ui.horizontal(|ui| {
                    ...
                    if ui
                        .add(Slider::new(&mut zoom, 0.5..=2.0).text(t!("ui.settings.app.zoom_factor")))
                        .changed()
                    {
            ...
            section_header(
                ui,
                icons::TABLE,
                &t!("ui.settings.replay.heading"),
                &t!("ui.settings.replay.description"),
            );
            ui.group(|ui| {
                ui.set_width(ui.available_width());
                ...
                egui::Grid::new("replay_columns_grid")
                    ...
                    .spacing([40.0, 4.0])
                    .show(ui, |ui| {
                        ui.checkbox(&mut self.tab_state.settings.replay_settings.show_raw_xp, t!("ui.settings.replay.show_raw_xp"));
                        ui.checkbox(&mut self.tab_state.settings.replay_settings.show_entity_id, t!("ui.settings.replay.show_entity_id"));
                        ui.end_row();
                        ...
                        ui.checkbox(&mut self.tab_state.settings.replay_settings.show_fires, t!("ui.settings.replay.show_fires"));
                        ui.end_row();

                        ui.checkbox(&mut self.tab_state.settings.replay_settings.show_floods, t!("ui.settings.replay.show_floods"));
                        ui.checkbox(&mut self.tab_state.settings.replay_settings.show_citadels, t!("ui.settings.replay.show_citadels"));
                        ui.end_row();
                    ...
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        ...
                        ui.with_layout(egui::Layout::left_to_right(egui::Align::Center), |ui| {
                            ...
                            egui::ComboBox::from_id_salt("auto_export_format_combobox")
                                ...
                                .show_ui(ui, |ui| {
                                    ui.selectable_value(selected_format, ReplayExportFormat::Json, t!("ui.settings.replay.format_json"));
                                    ui.selectable_value(selected_format, ReplayExportFormat::Csv, t!("ui.settings.replay.format_csv"));
                                    ui.selectable_value(selected_format, ReplayExportFormat::Cbor, t!("ui.settings.replay.format_cbor"));
                                });
