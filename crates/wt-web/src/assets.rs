...
pub struct AssetStore {
    ...
    pub ribbon_icons: HashMap<String, TextureHandle>,
    pub subribbon_icons: HashMap<String, TextureHandle>,
...
impl AssetStore {
    ...
    pub fn load_from_bundle(
        ...
        Self {
            ...
            ribbon_icons: upload(ribbon_icons, "ribbon"),
            subribbon_icons: upload(subribbon_icons, "subribbon"),
